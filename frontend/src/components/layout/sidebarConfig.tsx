...
export const sidebarItems = [
  {
    ...
    icon: 'dns',
    items: [
      { label: 'Overview', route: '/cluster-overview', icon: 'dashboard' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Resource Quotas', route: '/resourcequotas', icon: 'account_balance_wallet' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Cluster Role Bindings', route: '/clusterrolebindings', icon: 'link_off' },
    ],
  },
  {
    ...
    icon: 'extension',
    items: [
      { label: 'CRDs', route: '/customresourcedefinitions', icon: 'developer_board' },
    ],
  },
];
